...
const JobTitles: Record<MajorName, JobTitle[]> = {
  ...
  dkv: [
    ...
    },
    {
      ...
      description: "Digital Illustrator adalah profesional yang menciptakan ilustrasi digital untuk media cetak, web, dan animasi menggunakan perangkat lunak desain. Tanggung jawab utama: konseptualisasi, digital drawing, coloring, adaptasi untuk media. Keterampilan yang diperlukan: Adobe Illustrator, Photoshop, Wacom tablet, style development. Prospek karir: di publishing, game industry; kemungkinan menjadi concept artist; gaji berdasarkan karya.",
    },
  ],
  animasi: [
    {

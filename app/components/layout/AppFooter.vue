...
const isColoredBackground = computed(
    () => !props.bgColor || props.bgColor !== "#1f2937",
);
</script>
        ...
        <div class="container px-6 mx-auto">
            <div class="grid grid-cols-1 gap-8 md:grid-cols-4">
                <div class="md:col-span-1">
                    ...
                    >
                        Sekolah Menengah Kejuruan Negeri 2 Singosari berkomitmen
                        untuk mencetak lulusan yang unggul, berkarakter, dan
                ...
                <div class="md:col-span-1">
                    <h4
                        :class="[
                            ...
                            isColoredBackground ? 'text-white' : 'text-white',
                        ]"
                    >
                        Tautan Cepat
                    </h4>
                        ...
                        <div class="space-y-3">
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    >
                                        Jl. Perusahaan Raya No.20, Jajar,
                                        Tanjungtirto.
                                    </p>
                                    <p
                                        :class="[

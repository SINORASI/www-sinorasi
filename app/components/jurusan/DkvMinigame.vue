...
const sketches = [
  {
    id: 1,
    name: "Ino Pose 1",
    sketch: "/images/minigame/dkv/Ino1_sket.png",
    reference: "/images/minigame/dkv/Ino1_color.png",
  },
  {
    id: 2,
    name: "Ino Pose 2",
    sketch: "/images/minigame/dkv/Ino2_sket.png",
    reference: "/images/minigame/dkv/Ino2_color.png",
  },
  {
    id: 3,
    name: "Ino Pose 3",
    sketch: "/images/minigame/dkv/Ino pose 3 sketc.png",
    reference: "/images/minigame/dkv/Ino pose 1 color_.png",
  },
  {
    id: 4,
    name: "Ino Pose 4",
    sketch: "/images/minigame/dkv/Ino pose 4 sketc.png",
    reference: "/images/minigame/dkv/Ino pose 4 color.png",
  },
  {
    id: 5,
    name: "Rasi Pose 1",
    sketch: "/images/minigame/dkv/Rasi pose 1 sketc.png",
    reference: "/images/minigame/dkv/Rasi pose 1 color.png",
  },
  {
    id: 6,
    name: "Rasi Pose 2",
    sketch: "/images/minigame/dkv/Rasi1_sket.png",
    reference: "/images/minigame/dkv/Rasi1_color.png",
  },
  {
    id: 7,
    name: "Rasi Pose 3",
    sketch: "/images/minigame/dkv/Rasi2_sket.png",
    reference: "/images/minigame/dkv/Rasi2_color.png",
  },
  {
    id: 8,
    name: "Rasi Pose 4",
    sketch: "/images/minigame/dkv/Rasi pose 4 sketc.png",
    reference: "/images/minigame/dkv/Rasi pose 4 color.png",
  },
];
        ...
        <div>
          ...
          <div class="grid grid-cols-5 gap-2">
            <button
              ...
              :title="color"
            >
              <div v-if="activeColor === color" class="absolute inset-0 flex items-center justify-center">
                <svg
                  class="w-4 h-4"
                  :class="color === '#FFFFFF' || color === '#FFE0BD' ? 'text-gray-800' : 'text-white'"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
                  <path

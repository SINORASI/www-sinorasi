      ...
      >
        ...
        <div class="flex flex-col sm:flex-row items-center gap-3 mt-4">
          ...
          <a
            ...
            class="flex items-center gap-2 px-4 md:px-6 py-2 md:py-3 text-sm md:text-sm font-semibold text-orange-500 border-2 border-orange-500 rounded-lg hover:bg-orange-600 hover:text-white cursor-pointer shadow-lg hover:scale-105 transition-transform"
            role="button"

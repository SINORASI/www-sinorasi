        ...
        <div class="relative w-full overflow-hidden">
            ...
            <div class="py-8">
                <div ref="sliderRef" class="flex gap-12 slider-track w-max">
                    ...
                    >
                        <div
                            class="company-card p-6 rounded-[1rem] transition-all duration-300 hover:-translate-y-1"
                        >
                            <img
                                :src="company.logo"
                        ...
                        <p
                            class="mt-3 text-xs font-semibold text-center text-gray-700 sm:text-sm"
                        >
                            {{ company.name }}
                        </p>
                    </div>

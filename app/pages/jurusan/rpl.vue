...
const { data: majorDatas } =
    await useFetch<Record<MajorName, MajorData>>("/api/majors");
    ...
    <main class="overflow-hidden scroll-smooth">
        ...
        >
            <div
                ...
                :style="`background: ${majorColor.gradient}`"
            ></div>

            <div
                class="relative z-10 flex items-center w-full h-full min-h-screen"
            >
                <div class="container px-8 py-8 mx-auto">
                    <div
                        class="grid items-center grid-cols-1 gap-12 lg:grid-cols-2"
                    >
                        ...
                        <div
                            class="flex flex-col items-center justify-center gap-2 lg:items-end lg:space-y-8"
                        >
                            ...
                            <div class="relative w-full max-w-sm lg:max-w-md">
                                <img
                                    src="/images/major/hero-major-ornament/rpl/laptop.webp"
                                    alt="RPL Ornament"
                            ...
                            <div
                                class="px-6 py-3 bg-white shadow-2xl rounded-2xl lg:px-8 lg:py-4"
                            >
                                <p
            ...
            <div
                class="absolute z-20 transform -translate-x-1/2 bottom-8 left-1/2 animate-bounce"
            >
                <div
                ...
                >
                    <div
                        class="w-2 h-3 bg-white rounded-full animate-pulse"
                    ></div>
                </div>
            </div>
        </div>
        ...
        >
            <div
                class="container flex flex-col items-center gap-10 px-4 mx-auto md:gap-12"
            >
                <div class="max-w-3xl space-y-4 text-center">
                    ...
                    <p
                        class="max-w-2xl mx-auto text-sm text-gray-600 md:text-lg"
                    >
                        Dipimpin oleh tenaga pengajar profesional dan
        ...
        >
            <div
                class="container flex flex-col items-center justify-center gap-10 px-4 mx-auto md:gap-12"
            >
                <div class="max-w-3xl space-y-4 text-center">
                    <div class="inline-block">
                        <span
                    ...
                    <p
                        class="max-w-2xl mx-auto text-sm text-gray-600 md:text-lg"
                    >
                        Kurikulum yang dirancang untuk memenuhi kebutuhan
                        industri modern
                    </p>
                </div>
        ...
        >
            ...
            <div
                class="container relative z-10 flex flex-col items-center justify-center px-4 mx-auto"
            >
                <div class="max-w-4xl mb-12 space-y-4 text-center md:mb-16">
                    ...
                    <h2
                        class="text-3xl font-extrabold leading-tight md:text-5xl"
                        :style="`color: ${majorColor.primary}`"
                    >
                        Peluang Karir Setelah Lulus
                    </h2>
                    <p class="text-base text-gray-600 md:text-xl">
                        Berbagai kesempatan kerja menanti lulusan
        ...
        >
            <div
                class="container flex items-center justify-center px-4 mx-auto"
            >
                <div
                    class="flex flex-col items-center justify-center w-full gap-10 md:gap-12 max-w-7xl"
                >
                    <div class="space-y-4 text-center">
                        ...
                        <p
                            class="max-w-2xl mx-auto text-sm text-gray-600 md:text-lg"
                        >
                            Bekerja sama dengan perusahaan terkemuka untuk
                            pengalaman praktik kerja siswa
                        </p>
                    </div>
        ...
        >
            <div
                class="container flex flex-col items-center justify-center gap-8 px-4 mx-auto md:gap-12"
            >
                <div class="space-y-4 text-center">
                    <div class="inline-block">
                        <span
                    ...
                    <p
                        class="max-w-2xl mx-auto text-sm text-gray-600 md:text-lg"
                    >
                        Pelajari {{ majorDatas?.[major]?.short }} dengan cara
                        yang menyenangkan!
                    </p>
                </div>
                ...
                <div class="w-full max-w-6xl">
                    ...
                    >
                        <div class="absolute inset-0 opacity-10">
                            <div
                                class="absolute inset-0 bg-gradient-to-br from-white to-transparent animate-pulse"
                            ></div>
                        </div>
                        ...
                        <div class="relative z-10 space-y-6 text-center">
                            ...
                            <h3
                                class="text-2xl font-bold text-white md:text-4xl drop-shadow-lg"
                            >
                                Game {{ majorDatas?.[major]?.short }}
                            </h3>
                            <p
                                class="max-w-md mx-auto text-sm text-white/90 md:text-lg"
                            >
                                Segera hadir! Game interaktif untuk mengenal
                                lebih jauh tentang dunia
                                {{ majorDatas?.[major]?.short }}
                            </p>
                            <button
                        ...
                        <div
                            class="absolute w-20 h-20 border-4 rounded-full top-10 right-10 border-white/20 animate-ping"
                        ></div>
                        <div
            ...
            >
                <div class="mb-12 space-y-4 text-center md:mb-16">
                    ...
                    <p
                        class="max-w-2xl mx-auto text-sm text-gray-600 md:text-lg"
                    >
                        Berbagai pencapaian membanggakan yang telah diraih siswa
                        {{ majorDatas?.[major]?.short }}
                    </p>
                </div>
        ...
        <motion.button
            ...
            :style="{
                background: `linear-gradient(135deg, ${majorColor.primary}, ${majorColor.accent})`,
            }"

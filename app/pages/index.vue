            ...
            description: news.content
                ? news.content
                      ...
                      .slice(
                          0,
                          Math.floor(
                              news.content.replace(/<[^>]*>/g, "").length / 2,
                          ),
                      ) + "..."
                : news.subtitle,
            slug: news.slug,
    ...
    if (import.meta.client) {
        setTimeout(() => {
            ...
            animate(0, props.prestasiTarget, {
                ...
                ease: ease,
                onUpdate: (latest) =>
                    (prestasiCount.value = Math.floor(latest)),
            });
        ...
        const heroInterval = setInterval(() => {
            currentHeroImage.value =
                (currentHeroImage.value + 1) % heroImages.value.length;
        }, 5000);
...
<template>
    <main v-if="showContent" class="flex flex-col gap-52">
        ...
        >
            ...
            <div class="absolute top-100 right-30 z-0">
                <Icon
                    ...
                    size="120"
                    class="text-blue-300 opacity-10 hero-ornament-1"
                />
            </div>
            <div class="absolute bottom-59 right-130 z-0">
                <Icon
                    name="lucide:rocket"
                    size="140"
                    class="text-orange-300 opacity-8 hero-ornament-2"
                />
            </div>
            <div class="absolute top-50 left-100 z-0">
                <Icon
                    name="lucide:star"
                    size="110"
                    class="text-blue-400 opacity-12 hero-ornament-3"
                />
            </div>
            ...
            :inViewOptions="{ once: true }"
                >
                    ...
                    <p
                        class="text-lg font-semibold transition-all duration-700 ease-out md:text-xl lg:text-2xl"
                    >
                        INORASI - Inovasi Raih Prestasi
                    </p>
                    <p
                        class="max-w-2xl text-sm leading-relaxed transition-all duration-700 ease-out md:text-lg"
                    >
                        SMK Negeri 2 Singosari - Tempat di mana inovasi bertemu
                        dengan prestasi. Kami berkomitmen untuk membentuk
                        generasi muda yang siap menghadapi tantangan masa depan
                        melalui pendidikan kejuruan berkualitas.
                    </p>
                    <div
                        class="flex flex-col items-center gap-4 mt-4 sm:flex-row"
                    >
                        <a
                            href="#profil-sekolah"
                    ...
                    <div
                        class="flex justify-center w-full gap-8 mt-6 lg:justify-start"
                    >
                        <div class="flex flex-col items-center">
                            <div
                                class="text-xl font-bold transition-all duration-700 ease-out md:text-3xl"
                            >
                                {{ jurusanCount }}
                            </div>
                            <div
                                class="text-sm transition-all duration-700 ease-out md:text-lg"
                            >
        ...
        >
            <div class="absolute top-0 left-1/2 z-0">
                <Icon
                    ...
                    size="160"
                    class="text-blue-400 opacity-10 profil-ornament-1"
                />
            </div>
            <div class="absolute top-1/4 left-20 z-0">
                <Icon
                    name="lucide:book"
                    size="130"
                    class="text-orange-300 opacity-8 profil-ornament-2"
                />
            </div>
            <div class="absolute bottom-10 right-10 z-0">
                <Icon
                    name="lucide:school"
                    size="180"
                    class="text-blue-300 opacity-12 profil-ornament-3"
                />
            </div>
                        ...
                        >
                            <div class="space-y-6">
                                <p class="leading-relaxed text-gray-600">
                                    SMK Negeri 2 Singosari adalah lembaga
                                    pendidikan kejuruan yang berkomitmen untuk
                                    menghasilkan lulusan yang kompeten,
                                    inovatif, dan siap menghadapi tantangan
                                    dunia kerja modern.
                                </p>

                                <div class="grid grid-cols-2 gap-4">
                                    <div
                                        class="p-4 text-center rounded-lg bg-blue-50"
                                    >
                                        <div
                                    ...
                                    <div
                                        class="p-4 text-center rounded-lg bg-green-50"
                                    >
                                        <div
                                    ...
                                    <div
                                        class="p-4 text-center rounded-lg bg-purple-50"
                                    >
                                        <div
                                ...
                                <p class="leading-relaxed text-gray-600">
                                    Dengan fasilitas modern dan tenaga pengajar
                                    profesional, kami terus berinovasi dalam
                                    metode pembelajaran untuk mencapai visi
        ...
        >
            <div class="absolute top-20 right-50 z-0">
                <Icon
                    ...
                    size="150"
                    class="text-blue-300 opacity-10 sambutan-ornament-1"
                />
            </div>
            <div class="absolute bottom-20 right-12 z-0">
                <Icon
                    ...
                    size="125"
                    class="text-orange-300 opacity-8 sambutan-ornament-2"
                />
            </div>
            <div class="absolute top-1/2 left-16 z-0">
                <Icon
                    name="lucide:award"
                    size="170"
                    class="text-blue-400 opacity-12 sambutan-ornament-3"
                />
            </div>
            ...
            <div class="absolute top-5 left-70 z-0">
                <svg
                    ...
                    height="200"
                    viewBox="0 0 24 24"
                    class="text-yellow-300 opacity-20 large-svg-1"
                >
                    <path
                        fill="currentColor"
            ...
            :inViewOptions="{ once: true }"
                    >
                        ...
                        >
                            ...
                            >
                                <p>
                                    Puji syukur kepada Allah SWT atas terbitnya
                                    website SMK Negeri 2 Singosari untuk
                                    menjawab kebutuhan informasi melalui
                                    teknologi informasi. Dalam memajukan
                                    pendidikan di era teknologi yang pesat,
                                    diperlukan sarana prasarana kondusif dan
                                    informasi bagi siswa, guru, orangtua maupun
                                    masyarakat.
                                </p>
                                <p>
                                    Besar harapan kami sarana ini memberi
                                    manfaat bagi semua pihak di lingkup
                                    pendidikan khususnya SMK Negeri 2 Singosari.
                                    Kami mengharapkan masukan dari berbagai
                                    pihak agar terus belajar dan meng-update
                                    sehingga tampilan, isi dan mutu website
                                    berkembang lebih baik. Terima kasih atas
                                    kerjasamanya, maju terus SMK Negeri 2
                                    Singosari.
                                </p>
                        ...
                        <div class="relative max-w-xs group">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <p
                                        class="text-sm text-center text-white/90"
                                    >
                                        Kepala Sekolah SMKN 2 Singosari
                                    </p>
                                </div>
                            </div>
                            <div
        ...
        >
            ...
            <div class="absolute bottom-20 left-10 z-0">
                <Icon
                    name="lucide:trophy"
                    size="120"
                    class="text-orange-300 opacity-10 prestasi-ornament-1"
                />
            </div>
            <div class="absolute top-0 right-80 z-0">
                <Icon
                    name="lucide:medal"
                    size="135"
                    class="text-blue-400 opacity-8 prestasi-ornament-2"
                />
            </div>
            <div class="absolute bottom-1/3 right-12 z-0">
                <Icon
                    name="lucide:star"
                    size="155"
                    class="text-orange-300 opacity-12 prestasi-ornament-3"
                />
            </div>

            <div
                class="container flex flex-col items-center gap-8 mx-auto relative z-10"
            >
                <motion.div
                ...
                >
                    <div class="overflow-hidden">
                        ...
                        >
                            ...
                            >
                                <NuxtLink
                                    v-if="achievement.slug"
                                    :to="`/berita/${achievement.slug}`"
                                    class="block cursor-pointer"
                                >
                                    <div
                                        class="flex flex-col items-center gap-8 md:flex-row md:h-80"
                                    >
                                        <img
                                        ...
                                        />
                                        <div
                                            class="flex flex-col gap-4 text-center md:text-left md:w-2/3 md:pr-5 md:justify-center"
                                        >
                                            <h3
                                            ...
                                            <p
                                                class="leading-relaxed text-gray-600 text-sm md:text-base line-clamp-4"
                                            >
        ...
        >
            <div
                class="absolute top-20 left-16 w-3 h-3 bg-yellow-300 rounded-full opacity-70 sparkle-1"
            ></div>
            <div
                class="absolute top-40 right-24 w-4 h-4 bg-blue-300 rounded-full opacity-60 sparkle-2"
            ></div>
            <div
                class="absolute bottom-32 left-12 w-2 h-2 bg-pink-300 rounded-full opacity-80 sparkle-3"
            ></div>
            ...
            <div class="absolute bottom-20 right-12 z-0">
                <Icon
                    name="lucide:badge"
                    size="165"
                    class="text-orange-300 opacity-8 seragam-ornament-2"
                />
            </div>
            <div class="absolute top-1/2 left-16 z-0">
                <Icon
                    name="lucide:shirt"
                    size="175"
                    class="text-blue-400 opacity-12 seragam-ornament-3"
                />
            </div>
            ...
            :inViewOptions="{ once: true }"
                    >
                        ...
                        <p class="max-w-2xl text-lg text-center text-white">
                            Koleksi seragam sekolah SMK Negeri 2 Singosari
                        </p>
                    </motion.div>

                    <div
                        class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 w-full max-w-[1600px]"
                    >
                        <UniformCard
                            :gradeImages="{
                                X: {
                    ...
                    <div
                        class="w-full max-w-4xl p-6 bg-white shadow-lg rounded-2xl"
                    >
                        <div class="flex gap-4">
                            <Icon
                                name="lucide:info"
                            ...
                            <div>
                                ...
                                <ul
                                    class="space-y-1 text-sm text-gray-600 list-disc list-inside"
                                >
                                    <li>
                                        Seragam harus dikenakan dengan rapi dan
                                        sesuai ketentuan
                                    </li>
                                    <li>
                                        Sepatu hitam dengan kaos kaki putih
                                        wajib digunakan setiap hari
                                    </li>
                                    <li>
                                        Atribut sekolah seperti name tag dan
                                        badge harus dipasang dengan benar
                                    </li>
                                    <li>
                                        Rambut harus dipotong rapi sesuai dengan
                                        peraturan sekolah
                                    </li>
                                </ul>
                            </div>
        ...
        >
            <div class="absolute top-20 right-1/4 z-0">
                <Icon
                    name="lucide:clock"
                    size="200"
                    class="text-blue-300 opacity-10 timeline-ornament-1"
                />
            </div>
            <div class="absolute bottom-32 right-12 z-0">
                <Icon
                    ...
                    size="140"
                    class="text-orange-300 opacity-8 timeline-ornament-2"
                />
            </div>
            <div class="absolute top-1/2 left-16 z-0">
                <Icon
                    name="lucide:scroll"
                    size="185"
                    class="text-blue-400 opacity-12 timeline-ornament-3"
                />
            </div>
            ...
            <div class="absolute top-1/4 left-10 z-0">
                <Icon
                    ...
                    size="75"
                    class="text-blue-300 opacity-20 large-icon-4"
                />
            </div>

            <div
                class="container relative flex flex-col items-center gap-8 px-4 mx-auto text-center md:px-10 z-10"
            >
                <div
                    class="absolute top-0 left-0 bg-blue-200 rounded-full w-72 h-72 opacity-20 blur-3xl z-10"
                ></div>
                <div
                    class="absolute bottom-0 right-0 bg-orange-200 rounded-full w-96 h-96 opacity-20 blur-3xl z-10"
                ></div>
                ...
                <div class="flex flex-col items-center gap-4">
                    ...
                    <p class="max-w-2xl my-5 text-lg text-gray-600">
                        Perjalanan panjang SMK Negeri 2 Singosari dalam
                        mengembangkan pendidikan kejuruan berkualitas di
                        Kabupaten Malang.
                    </p>

                    <div
                        class="flex items-center gap-3 px-6 py-3 bg-white border border-blue-100 rounded-full shadow-md"
                    >
                        <Icon
                            name="lucide:calendar"
                            size="20"
                        ...
                        <span class="font-bold text-blue-600"
                            >{{ timelineItems.length }} Milestone</span
                        >
                    </div>
                </div>
                ...
                <div
                    v-if="isMobile"
                    class="relative flex flex-col items-center w-full py-10"
                >
                    <motion.div
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <h3
                                    class="mb-3 text-xl font-bold text-gray-800"
                                >
                                    {{ item.title }}
                                </h3>
                                <p
                                    class="text-sm leading-relaxed text-justify text-gray-600"
                                >
                                    {{ item.description }}
                                </p>
                            </div>
                    ...
                    >
                        <div class="flex-1 min-w-[200px]">
                            ...
                            <p class="text-sm text-blue-100">
                                Lihat profil lengkap sekolah kami
                            </p>
                        </div>
                        <NuxtLink
        ...
        >
            <div class="absolute bottom-50 right-0 z-0">
                <svg
                    ...
                    height="300"
                    viewBox="0 0 24 24"
                    class="text-green-300 opacity-20 large-svg-jurusan"
                >
                    <path
                        fill="currentColor"
            ...
            <div class="absolute bottom-20 right-1/4 z-0">
                <Icon
                    name="lucide:compass"
                    size="210"
                    class="text-blue-300 opacity-10 jurusan-ornament-1"
                />
            </div>
            <div class="absolute bottom-20 right left-0 z-0">
                <Icon
                    name="lucide:route"
                    size="150"
                    class="text-orange-300 opacity-8 jurusan-ornament-2"
                />
            </div>
            ...
            <div
                class="container flex items-center justify-center mx-auto relative z-10"
            >
                <MajorCarousel />
            </div>
        </motion.section>
        ...
        >
            ...
            <div class="absolute top-20 right-1/4 z-0">
                <Icon
                    ...
                    size="220"
                    class="text-blue-300 opacity-10 berita-ornament-1"
                />
            </div>
            <div class="absolute bottom-20 right-12 z-0">
                <Icon
                    ...
                    size="160"
                    class="text-orange-300 opacity-8 berita-ornament-2"
                />
            </div>
            <div class="absolute top-1/2 left-16 z-0">
                <Icon
                    name="lucide:rss"
                    size="180"
                    class="text-blue-400 opacity-12 berita-ornament-3"
                />
            </div>
                    ...
                    >
                        ...
                        >
                            ...
                            <div class="flex flex-col flex-grow p-5">
                                <p
                                    class="mb-2 text-xs font-semibold text-blue-600"
                                >
                                    {{ news.tags.join(", ") }}
                                </p>
                                <h3
                                    class="flex-grow mb-2 font-bold text-gray-800"
                                >
                                    {{ news.title }}
                                </h3>
        ...
        >
            ...
            <div class="absolute top-1/4 left-10 z-0">
                <Icon
                    ...
                    size="70"
                    class="text-indigo-300 opacity-25 large-icon-5"
                />
            </div>
            ...
            <div class="absolute top-20 right-50 z-0">
                <Icon
                    name="lucide:help-circle"
                    size="230"
                    class="text-blue-300 opacity-10 faq-ornament-1"
                />
            </div>
            <div class="absolute bottom-20 right-12 z-0">
                <Icon
                    name="lucide:lightbulb"
                    size="170"
                    class="text-orange-300 opacity-8 faq-ornament-2"
                />
            </div>
            <div class="absolute top-1/2 left-16 z-0">
                <Icon
                    ...
                    size="190"
                    class="text-blue-400 opacity-12 faq-ornament-3"
                />
            </div>
...
.large-icon-4 {
    animation:
        ...
        rotate-very-slow 32s linear infinite;
}

.large-icon-5 {
    animation:
        float 9s ease-in-out infinite,
        rotate-very-slow 28s linear infinite reverse;
}

.large-svg-1 {
    animation:
        float 6s ease-in-out infinite,
        rotate-very-slow 22s linear infinite;
}

.large-svg-jurusan {
    animation:
        float 7s ease-in-out infinite,
        rotate-very-slow 30s linear infinite reverse;
}
...
.hero-ornament-1 {
    animation:
        float 6s ease-in-out infinite,
        rotate-very-slow 35s linear infinite;
}

.hero-ornament-2 {
    animation:
        float-delayed 8s ease-in-out infinite,
        rotate-very-slow 40s linear infinite reverse;
}

.hero-ornament-3 {
    animation:
        float-slow 7s ease-in-out infinite,
        rotate-very-slow 38s linear infinite;
}

.profil-ornament-1 {
    animation:
        float 7s ease-in-out infinite,
        rotate-very-slow 36s linear infinite;
}

.profil-ornament-2 {
    animation:
        float-delayed 9s ease-in-out infinite,
        rotate-very-slow 42s linear infinite reverse;
}

.profil-ornament-3 {
    animation:
        float-slow 8s ease-in-out infinite,
        rotate-very-slow 39s linear infinite;
}

.sambutan-ornament-1 {
    animation:
        float 6.5s ease-in-out infinite,
        rotate-very-slow 37s linear infinite;
}

.sambutan-ornament-2 {
    animation:
        float-delayed 8.5s ease-in-out infinite,
        rotate-very-slow 41s linear infinite reverse;
}

.sambutan-ornament-3 {
    animation:
        float-slow 7.5s ease-in-out infinite,
        rotate-very-slow 38s linear infinite;
}

.prestasi-ornament-1 {
    animation:
        float 7.5s ease-in-out infinite,
        rotate-very-slow 36s linear infinite;
}

.prestasi-ornament-2 {
    animation:
        float-delayed 9.5s ease-in-out infinite,
        rotate-very-slow 42s linear infinite reverse;
}

.prestasi-ornament-3 {
    animation:
        float-slow 8.5s ease-in-out infinite,
        rotate-very-slow 39s linear infinite;
}

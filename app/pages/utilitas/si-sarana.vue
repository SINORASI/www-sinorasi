    ...
    <div class="container px-4 mx-auto sm:px-6 lg:px-8">
      <div class="max-w-5xl mx-auto">
        ...
        <div class="mb-16 text-center animate-fade-in-up">
          ...
          <p class="max-w-3xl mx-auto text-lg text-gray-700 leading-relaxed animate-slide-in-left stagger-1 sm:text-xl">
            Sistem Informasi Sarana dan Prasarana sekolah. Laporkan kerusakan atau masalah fasilitas sekolah dengan mudah dan cepat.
            ...
            <div>
              ...
              <div v-else class="space-y-4">
                ...
                <div v-if="formData.attachments && formData.attachments.length < 5" class="text-center">
                  ...
                  <label for="additionalFileUpload" class="inline-flex items-center gap-3 px-6 py-3 text-sm font-medium text-orange-600 transition-all bg-orange-50 rounded-xl cursor-pointer hover:bg-orange-100 hover:scale-105">
        ...
        <div class="grid gap-6 mt-12 sm:gap-8 md:grid-cols-2">
          <div class="p-8 bg-white border border-blue-200 shadow-2xl rounded-3xl hover:shadow-3xl transition-all duration-300 hover:scale-105 transform animate-scale-in stagger-3">
            ...
            <p class="text-gray-600 leading-relaxed">Hubungi bagian tata usaha: <span class="font-semibold text-blue-600">(0341) 123456</span></p>
          </div>

          <div class="p-8 bg-white border border-green-200 shadow-2xl rounded-3xl hover:shadow-3xl transition-all duration-300 hover:scale-105 transform animate-scale-in stagger-4">
            ...
            <p class="text-gray-600 leading-relaxed">Segera hadir: <span class="font-semibold text-green-600">Fitur tracking laporan Anda</span></p>
          </div>
        </div>
      </div>
    </div>

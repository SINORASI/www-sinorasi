...
<template>
    <main>
        <div
            class="min-h-screen py-24 bg-gradient-to-br from-gray-50 via-white to-gray-100"
        >
                ...
                >
                    ...
                    >
                        ...
                        <div class="absolute inset-0 opacity-10">
                            <div
                                class="absolute inset-0 bg-gradient-to-br from-orange-400/20 to-transparent"
                            ></div>
                        </div>
                        <div
                        ...
                        <div class="relative z-10">
                            ...
                            >
                                ...
                                />
                                <span
                                    class="text-sm font-semibold text-orange-300 uppercase tracking-wider"
                                    >Partnership Program</span
                                >
                            </div>
                            <h1
                                class="mb-6 text-5xl font-extrabold text-white md:text-6xl lg:text-7xl tracking-tight"
                            >
                                MITRA
                                <span class="text-orange-400">INDUSTRI</span>
                            </h1>
                            <p
                                class="max-w-4xl mx-auto text-xl leading-relaxed text-gray-300 font-medium"
                            >
                                Membangun kemitraan strategis antara SMK Negeri
                                02 Singosari dengan dunia industri untuk
                                menciptakan generasi muda yang siap kerja,
                                inovatif, dan berkontribusi bagi kemajuan bangsa
                            </p>
                            <div
                                class="flex flex-wrap justify-center gap-8 mt-8 text-sm text-gray-400"
                            >
                    ...
                    <div
                        class="px-8 py-12 bg-gradient-to-r from-slate-50 to-gray-100 border-b border-gray-200"
                    >
                        <div class="grid gap-8 md:grid-cols-3">
                            <div class="text-center">
                                <div
                                    class="inline-flex items-center justify-center w-16 h-16 mb-4 bg-orange-400/20 rounded-full"
                                >
                                    <Icon
                                ...
                                <p class="text-sm text-gray-600">
                                    Program magang dan praktik kerja untuk
                                    pengembangan keterampilan siswa
                                </p>
                            </div>
                            <div class="text-center">
                                <div
                                    class="inline-flex items-center justify-center w-16 h-16 mb-4 bg-slate-600/20 rounded-full"
                                >
                                    <Icon
                                        name="lucide:users"
                                        size="32"
                                ...
                                <p class="text-sm text-gray-600">
                                    Penyaluran tenaga kerja terampil ke dunia
                                    industri
                                </p>
                            </div>
                            <div class="text-center">
                                ...
                                <p class="text-sm text-gray-600">
                                    Pengembangan teknologi dan inovasi bersama
                                    mitra industri
                                </p>
                            </div>
                        </div>
                    ...
                    <div
                        class="px-8 py-16 bg-gradient-to-b from-white to-slate-50"
                    >
                        <div class="mb-8 text-center">
                            ...
                            <p class="text-gray-600">
                                Klik pada kartu perusahaan untuk melihat detail
                                kemitraan
                            </p>
                        </div>
                        <div
                        ...
                        <div class="grid gap-8 md:grid-cols-2 md:gap-12">
                            <div class="flex flex-col">
                                ...
                                <div class="mt-6 grid grid-cols-2 gap-4">
                                    ...
                                    <div
                                        class="text-center p-4 bg-orange-50 rounded-xl border border-orange-200"
                                    >
                                        <Icon
                                            name="lucide:calendar"
                                            size="24"
                                            class="mx-auto mb-2 text-orange-600"
                                        />
                                        <div
                            ...
                            <div class="flex flex-col">
                                <div class="mb-6">
                                    ...
                                    <h2
                                        class="text-3xl font-bold text-gray-900 md:text-4xl tracking-tight"
                                    >
                                ...
                                <div class="mb-6">
                                    <h3
                                        class="flex items-center mb-4 text-lg font-bold text-gray-800"
                                    >
                                        <Icon
                                            name="lucide:handshake"
                                            size="20"
                                    ...
                                    <div
                                        class="p-6 bg-gradient-to-r from-slate-50 to-gray-50 rounded-xl border border-slate-200"
                                    >
                                        <p

    ...
    <div class="container px-4 mx-auto sm:px-6">
      <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-col gap-4 mb-8 md:flex-row md:items-center md:justify-between">
          ...
          <button class="flex items-center gap-2 px-6 py-3 font-semibold text-white transition-colors bg-purple-600 rounded-lg shadow-md hover:bg-purple-700 hover:shadow-lg">
          ...
          >
            ...
            <div class="flex items-center gap-4 mb-4">
              ...
              <div class="flex-1">
                ...
                <p class="text-sm text-purple-600 font-medium">{{ org.established ? `Sejak ${org.established}` : 'Tahun Berdiri Tidak Diketahui' }}</p>
              </div>
            </div>
            ...
            <div class="flex gap-2">
              ...
              <button class="flex-1 flex items-center justify-center gap-2 px-3 py-2 text-sm font-semibold text-orange-600 transition-colors bg-orange-100 rounded-lg hover:bg-orange-200">
                <Icon name="lucide:edit" size="16" />
                Edit
              </button>
              <button class="flex items-center justify-center gap-2 px-3 py-2 text-sm font-semibold text-red-600 transition-colors bg-red-100 rounded-lg hover:bg-red-200">
